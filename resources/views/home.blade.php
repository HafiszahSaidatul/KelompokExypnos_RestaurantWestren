  ...
  <div class="container mt-5 mb-5">
    <div class="row">
      <div class="col-lg-4">
        <main class="form-registration w-100 m-auto">
          ...
          <form action="/register" method="post">
            ...
            <div class="form-floating">
              <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" placeholder="phone" requiredvalue="{{ old('phone') }}">
            ...
            <div class="form-floating">
              <input type="date" name="tgl" class="form-control rounded-bottom @error('tgl') is-invalid @enderror" id="tgl" placeholder="tgl" required>
              <label for="tgl"></label>
              @error('tgl')
                <div class="invalid-feedback">
                  {{ $message }} 
      ...
      <div class="col">
        ...
        <p>From signature delights such as Sakizuke and the best Nigiri Sushi & Soup, all the way to unique specialties such as Agemono, Yakimono or Dessert.<p>
      </div>
    </div>
  </div>
@endsection